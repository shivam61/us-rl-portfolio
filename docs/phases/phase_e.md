...
| 2026-05-03 | E.8 training | Complete | sp500. Rolling 252d peak drawdown. Best val Sharpe `1.0923` at episode 49; early stopping at episode 99. Total time `128 min`. |
| 2026-05-03 | E.8 evaluation | **REJECT — regression** | Five-way holdout (2019–2026-04-24). Trained RL: Sharpe `1.277`, MaxDD `−24.54%`, avg equity `0.396`. 7/8 gates pass — p75 gate fails (`1.277 < 1.280`). Regression vs E.7 on all three dimensions: Sharpe −0.019, avg equity −0.010, p75 gate lost. Hypothesis disproved: rolling peak resets faster in recovery regimes, creating fresh penalties earlier → RL more defensive in 2021/2023, not less (2021 recovery Sharpe 1.593 vs B.5 2.420). Expanding all-time-high peak retained. `reward_v2.py` reverted to E.7 state. E.7 remains the promoted result. |
